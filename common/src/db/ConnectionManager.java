...
public abstract class ConnectionManager {
	...
	protected static ConsoleLogger logger = new ConsoleLogger(
	...
	public ConnectionManager(String host, String user, String passowrd,
		...
		if (poolSize <= maxParallelConnection)
			maxParallelConnection = poolSize;
		else
			throw new RuntimeException("At max " + maxParallelConnection
